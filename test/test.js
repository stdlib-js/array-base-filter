...
tape( 'if provided an empty collection, the function returns an empty collection (typed array)', function test( t ) {
	...
	t.strictEqual( instanceOf( actual, Float64Array ), true, 'returns expected value' );
	t.deepEqual( actual, expected, 'returns expected value' );
	t.end();
...
tape( 'the function an empty collection if all elements fail a test (generic)', function test( t ) {
	var expected;
	var actual;
	var arr;
...
tape( 'the function an empty collection if all elements fail a test (typed array)', function test( t ) {
	var expected;
	var actual;
	var arr;
...
tape( 'the function an empty collection if all elements fail a test (accessor)', function test( t ) {
	var expected;
	var actual;
	var arr;
...
tape( 'the function an empty collection if all elements fail a test (array-like object)', function test( t ) {
	var expected;
	var actual;
	var arr;
...
tape( 'the function supports providing an execution context', function test( t ) {
	...
	arr = [ 1, 2, 3 ];
	expected = [ 1, 2, 3 ];
	actual = filter( arr, predicate, ctx );
